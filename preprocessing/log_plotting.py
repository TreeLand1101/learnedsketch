...
def plot_flows(log_file, top_k, rank, save_dir):
    flow_data = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_file', type=str, required=True, help='Path to the log file generated by the analysis script.')
    ...
    plot_flows(args.log_file, args.top_k, args.rank, args.save)
